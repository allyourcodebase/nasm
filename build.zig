...
pub fn build(b: *std.Build) void {
    ...
    exe.root_module.addConfigHeader(b.addConfigHeader(.{
        ...
        .HAVE_DECL_STRICMP = 0,
        .HAVE_DECL_STRLCPY = @as(c_int, if (t.os.tag.isBSD()) 1 else 0),
        .HAVE_DECL_STRNCASECMP = 0,
        .HAVE_DECL_STRNICMP = 0,
        .HAVE_DECL_STRNLEN = 0,
        .HAVE_DECL_STRRCHRNUL = 0,
        .HAVE_DECL_STRSEP = @as(c_int, if (t.os.tag.isBSD()) 1 else 0),
        ...
        .HAVE_ISASCII = 1,
        .HAVE_ISCNTRL = 1,
        .HAVE_MACHINE_ENDIAN_H = have(t.os.tag.isBSD()),
        ...
        .HAVE_STRINGS_H = 1,
        .HAVE_STRING_H = 1,
        .HAVE_STRLCPY = have(t.os.tag.isBSD()),
        .HAVE_STRNCASECMP = 1,
        .HAVE_STRNICMP = 1,
        .HAVE_STRNLEN = 1,
        .HAVE_STRRCHRNUL = null,
        .HAVE_STRSEP = have(t.os.tag.isBSD()),
        .HAVE_STRUCT_STAT = null,
        .HAVE_STRUCT__STATI64 = null,
        .HAVE_SYSCONF = null,
        .HAVE_SYS_ENDIAN_H = have(t.os.tag.isBSD()),
        .HAVE_SYS_MMAN_H = 1,

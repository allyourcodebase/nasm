...
pub fn build(b: *std.Build) void {
    ...
    const one: i64 = 1;
    const Restrict = enum { restrict, __restrict__ };
    ...
    exe.root_module.addConfigHeader(b.addConfigHeader(.{
        ...
        .CFLAGS_FDATA_SECTIONS = if (t.os.tag == .macos) one else null,
        .CFLAGS_FFUNCTION_SECTIONS = if (t.os.tag == .macos) one else null,
        .CFLAGS_FGNU89_INLINE = null,
        .CFLAGS_FLTO = null,
        .CFLAGS_FNO_COMMON = if (t.os.tag == .macos) one else null,
        .CFLAGS_FNO_OMIT_FRAME_POINTER = null,
        .CFLAGS_FSANITIZE_ADDRESS = null,
        .CFLAGS_FSANITIZE_UNDEFINED = null,
        .CFLAGS_FTRIVIAL_AUTO_VAR_INIT_ZERO = if (t.os.tag == .macos) one else null,
        .CFLAGS_FVISIBILITY_HIDDEN = if (t.os.tag == .macos) one else null,
        .CFLAGS_FWRAPV = if (t.os.tag == .macos) one else null,
        .CFLAGS_GGDB3 = if (t.os.tag == .macos) one else null,
        ...
        // .CFLAGS_STD_C23 = 1,
        .CFLAGS_STD_C99 = null,
        .CFLAGS_U_STRICT_ANSI = if (t.os.tag == .macos) one else null,
        .CFLAGS_W = null,
        .CFLAGS_WALL = null,
        ...
        .HAVE_ACCESS = 1,
        // .HAVE_ARPA_INET_H = if (t.os.tag == .macos) one else null,
        .HAVE_CANONICALIZE_FILE_NAME = null,
        .HAVE_CPU_TO_LE16 = null,
        .HAVE_CPU_TO_LE32 = null,
        .HAVE_CPU_TO_LE64 = null,
        .HAVE_DECL_STRCASECMP = if (t.os.tag == .macos) one else null,
        .HAVE_DECL_STRICMP = null,
        .HAVE_DECL_STRLCPY = if (t.os.tag == .macos) one else null,
        .HAVE_DECL_STRNCASECMP = if (t.os.tag == .macos) one else null,
        .HAVE_DECL_STRNICMP = null,
        .HAVE_DECL_STRNLEN = if (t.os.tag == .macos) one else null,
        .HAVE_DECL_STRRCHRNUL = null,
        .HAVE_DECL_STRSEP = if (t.os.tag == .macos) one else null,
        .HAVE_ENDIAN_H = if (t.os.tag != .macos) {} else null,
        .HAVE_FACCESSAT = 1,
        .HAVE_FCNTL_H = 1,
        .HAVE_FILENO = 1,
        .HAVE_FSEEKO = 1,
        ...
        .HAVE_FUNC_ATTRIBUTE2_ALLOC_SIZE = if (t.os.tag == .macos) one else null,
        ...
        // .HAVE_FUNC_NAME = if (t.os.tag == .macos) one else null,
        .HAVE_FUNC_PTR_ATTRIBUTE1_ALLOC_SIZE = 1,
        .HAVE_FUNC_PTR_ATTRIBUTE2_ALLOC_SIZE = if (t.os.tag == .macos) one else null,
        ...
        .HAVE_FUNC_PTR_ATTRIBUTE_PURE = if (t.os.tag == .macos) one else null,
        .HAVE_FUNC_PTR_ATTRIBUTE_RETURNS_NONNULL = 1,
        .HAVE_FUNC_PTR_ATTRIBUTE_SENTINEL = if (t.os.tag == .macos) null else one,
        .HAVE_FUNC_PTR_ATTRIBUTE_UNUSED = 1,
        .HAVE_GETGID = if (t.os.tag == .macos) one else null,
        .HAVE_GETPAGESIZE = if (t.os.tag == .macos) one else null,
        .HAVE_GETRLIMIT = if (t.os.tag == .macos) one else null,
        .HAVE_GETUID = if (t.os.tag == .macos) one else null,
        // .HAVE_HTOBE16 = if (t.os.tag == .macos) one else null,
        // .HAVE_HTOBE32 = if (t.os.tag == .macos) one else null,
        // .HAVE_HTOBE64 = if (t.os.tag == .macos) one else null,
        .HAVE_HTOLE16 = if (t.os.tag == .macos) one else null,
        .HAVE_HTOLE32 = if (t.os.tag == .macos) one else null,
        .HAVE_HTOLE64 = if (t.os.tag == .macos) one else null,
        .HAVE_INTRIN_H = if (t.os.tag == .macos) null else one,
        .HAVE_INTTYPES_H = 1,
        .HAVE_IO_H = null,
        .HAVE_ISASCII = 1,
        .HAVE_ISCNTRL = 1,
        .HAVE_MACHINE_ENDIAN_H = if (t.os.tag == .macos) one else null,
        .HAVE_MEMPCPY = if (t.os.tag == .macos) null else one,
        .HAVE_MEMPSET = null,
        .HAVE_MINIX_CONFIG_H = null,
        .HAVE_MMAP = 1,
        .HAVE_PATHCONF = if (t.os.tag == .macos) one else null,
        .HAVE_REALPATH = 1,
        .HAVE_SNPRINTF = 1,
        .HAVE_STAT = 1,
        .HAVE_STDARG_H = 1,
        ...
        .HAVE_STRCASECMP = 1,
        .HAVE_STRICMP = if (t.os.tag == .macos) null else one,
        .HAVE_STRINGS_H = 1,
        .HAVE_STRING_H = 1,
        .HAVE_STRLCPY = if (t.os.tag == .macos) {} else null,
        .HAVE_STRNCASECMP = 1,
        .HAVE_STRNICMP = if (t.os.tag == .macos) null else one,
        .HAVE_STRNLEN = 1,
        .HAVE_STRRCHRNUL = null,
        .HAVE_STRSEP = if (t.os.tag == .macos) one else null,
        .HAVE_STRUCT_STAT = if (t.os.tag == .macos) one else null,
        .HAVE_STRUCT__STATI64 = null,
        .HAVE_SYSCONF = if (t.os.tag == .macos) one else null,
        .HAVE_SYS_ENDIAN_H = 1,
        .HAVE_SYS_MMAN_H = 1,
        .HAVE_SYS_PARAM_H = if (t.os.tag == .macos) one else null,
        .HAVE_SYS_RESOURCE_H = if (t.os.tag == .macos) one else null,
        .HAVE_SYS_STAT_H = 1,
        .HAVE_SYS_TYPES_H = 1,
        .HAVE_S_ISREG = if (t.os.tag == .macos) one else null,
        .HAVE_TYPEOF = if (t.os.tag == .macos) one else null,
        // .HAVE_UINT_MAX_T = 1,
        .HAVE_UINTPTR_T = 1,
        .HAVE_UNISTD_H = if (t.os.tag == .macos) one else null,
        // .HAVE_UNSIGNED_LONG_LONG_INT = 1,
        // .HAVE_VARIADIC_MACROS = 1,
        .HAVE_VSNPRINTF = if (t.os.tag == .macos) one else null,
        .HAVE_WCHAR_H = if (t.os.tag == .macos) one else null,
        .HAVE__ACCESS = null,
        ...
        .HAVE__FULLPATH = null,
        .HAVE__STATI64 = null,
        .HAVE___BSWAP_16 = if (t.os.tag == .macos) null else one,
        .HAVE___BSWAP_32 = if (t.os.tag == .macos) null else one,
        .HAVE___BSWAP_64 = if (t.os.tag == .macos) null else one,
        .HAVE___BUILTIN_BSWAP16 = if (t.os.tag == .macos) null else one,
        .HAVE___BUILTIN_BSWAP32 = if (t.os.tag == .macos) null else one,
        .HAVE___BUILTIN_BSWAP64 = if (t.os.tag == .macos) null else one,
        ...
        .@"const" = .@"const",
        .@"inline" = .@"inline",
        .restrict = if (t.os.tag == .macos) Restrict.__restrict__ else Restrict.restrict,
        .size_t = null,
        .snprintf = null,
        .typeof = .__typeof,
        .uintptr_t = null,
